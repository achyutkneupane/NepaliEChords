...
class CRD_Sheet_Music
{
    ...
    public static function register()
    {
        $labels = array(
            'name'               => 'Chords & Tabs',
            'singular_name'      => 'Chords & Tabs',
            'menu_name'          => 'Chords & Tabs',
            'name_admin_bar'     => 'Chords & Tabs',
            'add_new'            => 'Add New',
            ...
            'search_items'       => 'Search Chord',
            'parent_item_colon'  => 'Parent:',
            'not_found'          => 'No chords or tabs found.',
            'not_found_in_trash' => 'No chords or tabs found in trash.'
        );

        $args = array(
            'public'      => true,
            'labels'      => $labels,
            'description' => 'Chords & Tabs',
            'taxonomies'  => array('post_tag', 'category', 'artist'),
    ...
    public static function song_title($content)
    {
        global $post;
