...
class SocialSnap_Metabox {
	...
	public function render_classic( $post ) {
		...
		echo wp_kses( apply_filters( 'socialsnap_metabox_output', $output ), socialsnap_get_allowed_html_tags( 'post' ) );
	}
	...
	public function render_block_editor( $post ) {
		...
		echo wp_kses( apply_filters( 'socialsnap_metabox_block_editor_output', $output ), socialsnap_get_allowed_html_tags( 'post' ) );
	}
}
