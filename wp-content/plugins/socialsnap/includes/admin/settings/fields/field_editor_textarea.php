	...
	public function render() {
		...
		<div id="<?php echo esc_attr( $this->id ); ?>_wrapper" class="ss-field-wrapper ss-field-textarea ss-clearfix"<?php SocialSnap_Fields::dependency_builder( $this->dependency ); ?>>
			...
			<div class="ss-right-section">
				<textarea <?php echo esc_attr( $this->placeholder ); ?> name="<?php echo esc_attr( $this->id ); ?>" id="<?php echo esc_attr( $this->id ); ?>" rows="<?php echo esc_attr( $this->rows ); ?>"<?php echo esc_html( $additional_params ); ?>><?php echo wp_kses_post( $this->value ); ?></textarea>
