	...
	public function render() {
		...
		<div id="<?php echo esc_attr( $this->id ); ?>_wrapper" class="ss-field-wrapper ss-field-text ss-clearfix"<?php SocialSnap_Fields::dependency_builder( $this->dependency ); ?>>
			...
			<div class="ss-right-section">
				<input type="<?php echo esc_attr( $this->value_type ); ?>" <?php echo esc_html( $this->placeholder ); ?> name="<?php echo esc_attr( $this->id ); ?>" id="<?php echo esc_attr( $this->id ); ?>" value="<?php echo esc_attr( $this->value ); ?>" <?php echo esc_html( $additional_params ); ?>/>
