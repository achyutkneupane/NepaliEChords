				...
				<div id="ss-right-panel" class="ss-no-previews">
					...
					<div class="ss-bottom-bar ss-clearfix">
						...
						<?php if ( ! socialsnap()->pro ) { ?>
							<a href="<?php echo esc_url( socialsnap_upgrade_link() ); ?>" target="_blank" class="ss-upgrade ss-button"><?php echo socialsnap()->icons->get_svg( 'socialsnap-icon' ); // phpcs:ignore ?><?php esc_html_e( 'Upgrade Now', 'socialsnap' ); ?></a>
						<?php } else { ?>
